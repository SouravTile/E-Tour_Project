...
import './SearchDropdown.css'
  ...
  let navigate = useNavigate();
    ...
    const fetchDataByName = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:8081/api/categorymaster/bysubcatId/"+searchName);
  ...
  const fetchDataByCost = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:8081/api/cost_master/cost/"+searchCost);
  ...
  const handleDateSearch = async () => {
        try {
          ...
          const response = await axios.get("http://localhost:8081/api/date_master/filtered?startDate="+startDate+"&endDate="+endDate);
